...
def _show_upgrade_prompt(context: str = "general") -> None:
    ...
    st.info(
        f"**Free plan** · {msg}\n\n"
        f"[Upgrade to Pro — $29/month](mailto:hello@analyticbi.com?subject=Upgrade%20to%20Pro)"
    )
...
def render_action_center(df: pd.DataFrame, product_clusters):
    ...
    if not all_actions:
        st.info("Upload your sales data to see your personalized action plan — Analytic will rank the most impactful things you can do today, from price changes to product promotions.")
        return
...
def render_pricing_page(df: pd.DataFrame = None, product_clusters=None):
    ...
    st.markdown(
        ...
        "Businesses using Analytic find an average of 3 immediate actions to take in their first session — "
    ...
    with col_pro:
        ...
        st.link_button(
            "Upgrade to Pro",
            url="mailto:hello@analyticbi.com?subject=Upgrade%20to%20Pro&body=I'd%20like%20to%20upgrade%20my%20Analytic%20account%20to%20Pro.",
            use_container_width=True,
            type="primary",
        )
    ...
    st.markdown(
        ...
        "Questions? Email <a href='mailto:hello@analyticbi.com' style='color:#2563eb;'>hello@analyticbi.com</a>"
        "</p>",
        unsafe_allow_html=True,
    )
